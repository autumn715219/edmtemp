    ...
    <Header style={headerStyle}>
      <HeaderContainer>
        <PageSelected>
          ...
          <Button onClick={showEditPageModal} style={{ marginLeft: '20px' }}>
            编辑当前页
          </Button>
          <Button onClick={removePage} style={{ marginLeft: '20px' }} danger>
            删除当页
          </Button>
        </PageSelected>
        <div>
          <ButtonGroup>
            <Button style={{ marginRight: '20px' }} onClick={undoClick}>
              后退
            </Button>
            <Button style={{ marginRight: '30px' }} onClick={redoClick}>
              前进
            </Button>
            <Button type='link' icon={<EyeOutlined />} onClick={preview}>
              预览
            </Button>
          </ButtonGroup>
          <ButtonGroup>
          ...
          {/* <ButtonGroup marginLeft='30px'>
            <Button type='primary' size='large' icon={<SendOutlined />} onClick={publish}>
              发布
            </Button>
          </ButtonGroup> */}
        </div>
